     ...
     println 'This is current Org'
        ...
        withCredentials([file(credentialsId: SERVER_KEY_CREDENTALS_ID, variable: 'server_key_file')]) {
            ...
            stage('Create Test Scratch Org') {
                rc = command "${toolbelt}/sfdx force:org:create --targetdevhubusername ${HUB_ORG_DH} --setdefaultusername --definitionfile config/project-scratch-def.json --setalias jorg --wait 10 --durationdays 1"
                if (rc != 0) {
